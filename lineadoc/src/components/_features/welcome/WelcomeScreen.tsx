        ...
        <div className="min-h-full w-full flex flex-col items-center justify-center bg-slate-50 p-6 animate-in fade-in duration-500 relative">
            ...
            <div className="max-w-2xl w-full text-center space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-lg mx-auto">
                    ...
                    <a
                        href="/textlint-demo"
                        className="group flex flex-col items-center p-8 bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-amber-300 hover:-translate-y-1 transition-all duration-200 md:col-span-2 lg:col-span-2"
                    >
                        <div className="w-16 h-16 bg-amber-50 text-amber-600 rounded-full flex items-center justify-center mb-4 group-hover:bg-amber-600 group-hover:text-white transition-all duration-300 shadow-inner">
                        ...
                        <h3 className="text-lg font-bold text-slate-900 mb-2">校正システム (Demo)</h3>
                        <p className="text-sm text-slate-500 leading-relaxed">
                            文化庁基準準拠の文書校正システムを試す (2万人規模実証用)
                        </p>
                    </a>
                </div>
