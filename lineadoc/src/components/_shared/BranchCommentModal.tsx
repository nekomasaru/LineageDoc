...
// Remove unused import from React if needed, but keeping it simple
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="p-5">
                    ...
                    <input
                        ...
                        placeholder={t('modal.branch.placeholder')}
